...
func (r *QQRobot) RegisterHandlers() {
	...
	r.cqBot.Client.GroupMessageEvent.Subscribe(r.OnGroupMessage)
	r.cqBot.Client.PrivateMessageEvent.Subscribe(r.OnPrivateMessage)
	// if base.ReportSelfMessage {
	// 	r.cqBot.Client.SelfPrivateMessageEvent.Subscribe(r.cqBot.privateMessageEvent)
	// 	r.cqBot.Client.SelfGroupMessageEvent.Subscribe(r.cqBot.groupMessageEvent)
	// }
	r.cqBot.Client.TempMessageEvent.Subscribe(r.OnTempMessage)
	// r.cqBot.Client.GuildService.OnGuildChannelMessage(r.cqBot.guildChannelMessageEvent)
	// r.cqBot.Client.GuildService.OnGuildMessageReactionsUpdated(r.cqBot.guildMessageReactionsUpdatedEvent)
	// r.cqBot.Client.GuildService.OnGuildMessageRecalled(r.cqBot.guildChannelMessageRecalledEvent)
	// r.cqBot.Client.GuildService.OnGuildChannelUpdated(r.cqBot.guildChannelUpdatedEvent)
	// r.cqBot.Client.GuildService.OnGuildChannelCreated(r.cqBot.guildChannelCreatedEvent)
	// r.cqBot.Client.GuildService.OnGuildChannelDestroyed(r.cqBot.guildChannelDestroyedEvent)
	// r.cqBot.Client.GroupMuteEvent.Subscribe(r.cqBot.groupMutedEvent)
	// r.cqBot.Client.GroupMessageRecalledEvent.Subscribe(r.cqBot.groupRecallEvent)
	// r.cqBot.Client.GroupNotifyEvent.Subscribe(r.cqBot.groupNotifyEvent)
	// r.cqBot.Client.FriendNotifyEvent.Subscribe(r.cqBot.friendNotifyEvent)
	// r.cqBot.Client.MemberSpecialTitleUpdatedEvent.Subscribe(r.cqBot.memberTitleUpdatedEvent)
	// r.cqBot.Client.FriendMessageRecalledEvent.Subscribe(r.cqBot.friendRecallEvent)
	// r.cqBot.Client.OfflineFileEvent.Subscribe(r.cqBot.offlineFileEvent)
	// r.cqBot.Client.GroupJoinEvent.Subscribe(r.cqBot.joinGroupEvent)
	// r.cqBot.Client.GroupLeaveEvent.Subscribe(r.cqBot.leaveGroupEvent)
	r.cqBot.Client.GroupMemberJoinEvent.Subscribe(r.OnGroupMemberJoined)
	// r.cqBot.Client.GroupMemberLeaveEvent.Subscribe(r.cqBot.memberLeaveEvent)
	// r.cqBot.Client.GroupMemberPermissionChangedEvent.Subscribe(r.cqBot.memberPermissionChangedEvent)
	// r.cqBot.Client.MemberCardUpdatedEvent.Subscribe(r.cqBot.memberCardUpdatedEvent)
	// r.cqBot.Client.NewFriendRequestEvent.Subscribe(r.cqBot.friendRequestEvent)
	// r.cqBot.Client.NewFriendEvent.Subscribe(r.cqBot.friendAddedEvent)
	// r.cqBot.Client.GroupInvitedEvent.Subscribe(r.cqBot.groupInvitedEvent)
	// r.cqBot.Client.UserWantJoinGroupEvent.Subscribe(r.cqBot.groupJoinReqEvent)
	// r.cqBot.Client.OtherClientStatusChangedEvent.Subscribe(r.cqBot.otherClientStatusChangedEvent)
	// r.cqBot.Client.GroupDigestEvent.Subscribe(r.cqBot.groupEssenceMsg)
}
